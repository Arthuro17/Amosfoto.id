...
<body>
  ...
  <!-- Banner -->
  <div class="container-fluid banner4 d-flex align-items-center">
    <div class="container">
      <h1 class="text-light text-center display-5">Wedding</h1>
    </div>
  </div>
  <!-- Akhir Banner -->
    ...
    <div class="container py-5">
      ...
      <div class="row text-center">
        <div class="col-md-4 mb-3 hovered-card">
          <div class="card">
            <img src="images/wedding1.jpg" width="340px" class="img-fluid img-responsive mx-auto d-block py-2" alt="card1">
          </div>
        </div>
        <div class="col-md-4 mb-3 hovered-card">
          <div class="card">
            <img src="images/wedding2.jpg" width="340px" class="img-fluid img-responsive mx-auto d-block py-2" alt="card2">
          </div>
        </div>
        <div class="col-md-4 mb-3 hovered-card">
          <div class="card">
            <img src="images/wedding3.jpg" width="340px" class="img-fluid img-responsive mx-auto d-block py-2" alt="card3">
          </div>
        </div>
        <div class="col-md-4 mb-3 hovered-card">
          <div class="card">
            <img src="images/wedding4.jpg" width="340px" class="img-fluid img-responsive mx-auto d-block py-2" alt="card1">
          </div>
        </div>
        <div class="col-md-4 mb-3 hovered-card">
          <div class="card">
            <img src="images/wedding5.jpg" width="340px" class="img-fluid img-responsive mx-auto d-block py-2" alt="card2">
          </div>
        </div>
        <div class="col-md-4 mb-3 hovered-card">
          <div class="card">
            <img src="images/wedding6.jpg" width="340px" class="img-fluid img-responsive mx-auto d-block py-2" alt="card3">
          </div>
        </div>
      </div>
    </div>
