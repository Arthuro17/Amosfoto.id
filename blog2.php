...
<body>
  ...
  <!-- Banner -->
  <div class="container-fluid banner5 d-flex align-items-center">
    <div class="container">
      <h1 class="text-light text-center display-5">Fashion</h1>
    </div>
  </div>
  <!-- Akhir Banner -->
    ...
    <div class="container py-5">
      ...
      <div class="row text-center">
        <div class="col-md-4 mb-3 hovered-card">
          <div class="card">
            <img src="images/fashion1.jpg" width="240px" class="img-fluid img-responsive mx-auto d-block py-2" alt="card1">
          </div>
        </div>
        <div class="col-md-4 mb-3 hovered-card">
          <div class="card">
            <img src="images/fashion2.jpg" width="240px" class="img-fluid img-responsive mx-auto d-block py-2" alt="card2">
          </div>
        </div>
        <div class="col-md-4 mb-3 hovered-card">
          <div class="card">
            <img src="images/fashion3.jpg" width="240px" class="img-fluid img-responsive mx-auto d-block py-2" alt="card3">
          </div>
        </div>
        <div class="col-md-4 mb-3 hovered-card">
          <div class="card">
            <img src="images/fashion4.jpg" width="240px" class="img-fluid img-responsive mx-auto d-block py-2" alt="card1">
          </div>
        </div>
        <div class="col-md-4 mb-3 hovered-card">
          <div class="card">
            <img src="images/fashion5.jpg" width="240px" class="img-fluid img-responsive mx-auto d-block py-2" alt="card2">
          </div>
        </div>
        <div class="col-md-4 mb-3 hovered-card">
          <div class="card">
            <img src="images/fashion6.jpg" width="240px" class="img-fluid img-responsive mx-auto d-block py-2" alt="card3">
          </div>
        </div>
      </div>
    </div>
