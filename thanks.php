...
<body>
  ...
  <!-- Banner -->
  <div class="container-fluid banner7 d-flex align-items-center">
    <div class="container">
      <h1 class="text-light text-center display-5">Thank you</h1>
      <h4 class="text-light text-center" style="font-weight: 100;">Terima kasih karena telah melakukan pembelian di toko kami. <br>Semoga hari Anda menyenangkan.</h4>
    </div>
  </div>
  <!-- Akhir Banner -->
